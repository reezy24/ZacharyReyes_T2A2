...
ActiveRecord::Schema.define(version: 2019_11_09_224930) do
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.index ["project_role_id"], name: "index_members_on_project_role_id"
  ...
  add_foreign_key "members", "project_roles"
